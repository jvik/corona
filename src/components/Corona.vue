        ...
        return {
            ...
            apiList: [
                ...
                },
                {
                    ...
                    url:
                        'https://lab.isaaclin.cn/nCoV/api/area?latest=1&province=挪威',
                    path: 'data.results[0]',
    ...
    methods: {
        ...
        request() {
            ...
            for (const selectedAPI of this.selectedAPIs) {
                if (
                    this.selectedAPIs.length !== this.responseData.series.length
                ) {
                    this.responseData.series = this.responseData.series.filter(
                        object => {
